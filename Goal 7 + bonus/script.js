// JavaScript Logic for Handling Start Form Submission
document.addEventListener('DOMContentLoaded', () => {
    ...
    startForm.addEventListener('submit', function (e) {
        ...
        // Redirect to the game page with category and difficulty parameters
    ...
    if (optionA.checked || optionB.checked || optionC.checked || optionD.checked) {
        ...
        if (selectedAnswer === currentQuestion.correct_answer) {
            ...
            if (currentQuestionIndex >= questions.length-1){
                window.location.href = `congratz.html`;
            }
        } else {
        ...
        if (currentQuestionIndex < questions.length) {
            ...
            showNotification(`Congratulations! Quiz finished! You win!`);
